        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/landOwner/add_land_owner.php" class="btn btn-primary">Add New Land Owner</a>
                            <a href="/landOwner/update_land_owner.php" class="btn btn-primary">Update Land Owner</a>
                            <a href="/landOwner/delete_land_owner.php" class="btn btn-primary">Delete Land Owner</a>
                            <table 	id="table"
