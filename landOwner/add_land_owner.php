...
// Enter the new user in the database
        ...
        if( $stmt->execute() ):
            $message = 'Successfully created new land owner';
        else:
...
<div id="content">
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <form action="add_land_owner.php" method="POST">
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="email">Name:</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Enter Land Owner Name" name="name">
                    </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-10">
                    <input type="password" class="form-control" placeholder="Enter land Owner Password" name="password">
                    </div>
                </div>
