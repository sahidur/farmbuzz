...
// Enter the new user in the database
        $sql = "INSERT INTO user (name, email, password, designation,location, usertype) VALUES (:name, :email, :password, :designation, :location, :usertype )";
        ...
        if( $stmt->execute() ):
            $message = 'Successfully created new lab';
        else:
        ...
        <div class="col-md-12">
            ...
            <form action="add_lab.php" method="POST">
                <div class="form-group ">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Enter Lab Name" name="name">
                    </div>
                </div>
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="email">Email:</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" placeholder="Enter lab Email" name="email">
                    </div>
                </div>
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="email">Password:</label>
                    <div class="col-sm-10">
                        <input type="password" class="form-control" placeholder="Enter lab Password" name="password">
                    </div>
                </div>
                ...
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-default">Add Lab</button>
                </div>
            </form>
            </form>
        </div>
