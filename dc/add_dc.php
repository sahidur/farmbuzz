...
// Enter the new user in the database
        ...
        if( $stmt->execute() ):
            $message = 'Successfully created new DC';
        else:
...
<div id="content">
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <form action="add_dc.php" method="POST">
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="email">Name:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Enter DC Name" name="name">
                    </div>
                </div>
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="email">Email:</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" placeholder="Enter DC Email" name="email">
                    </div>
                </div>
                <div class="form-group ">
                    <label class="control-label col-sm-2" for="email">Password:</label>
                    <div class="col-sm-10">
                        <input type="password" class="form-control" placeholder="Enter DC Password" name="password">
                    </div>
                </div>
