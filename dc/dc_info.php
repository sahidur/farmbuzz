        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/dc/add_dc.php" class="btn btn-primary">Add New DC</a>
                            <a href="/dc/update_dc.php" class="btn btn-primary">Update DC</a>
                            <a href="/dc/delete_dc.php" class="btn btn-primary">Delete DC</a>
                            <table 	id="table"
