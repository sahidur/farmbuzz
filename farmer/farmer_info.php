        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/farmer/add_farmer.php" class="btn btn-primary">Add New farmer</a>
                            <a href="/farmer/update_farmer.php" class="btn btn-primary">Update farmer</a>
                            <a href="/farmer/delete_farmer.php" class="btn btn-primary">Delete farmer</a>
                            <table 	id="table"
